...
if(isset($_GET['act'])){
    ...
    if($_GET['act']=='insert'){
        ...
        $id = mysqli_real_escape_string($konek, $_POST['idadmin']);
        $username = mysqli_real_escape_string($konek, $_POST['username']);
        $password = md5(mysqli_real_escape_string($konek, $_POST['password']));
        $namalengkap = mysqli_real_escape_string($konek, $_POST['namalengkap']);
        ...
        if($username=='' || $_POST['password']=='' || $namalengkap==''){
            ...
            if($simpan){
                ...
                header('location:data_admin.php?e=gagal' .mysqli_error($konek));
            }
        }
    ...
    }else{ //jika act bukan insert, update atau delet
